...
def outer():
    ...
    # keep calling function until "its there == true" NO MORE O LOOP
    # nested loops - f and i, call f once at bottom, call i at bottom of f (inside of it)
        ...
        # The new current node will have a green line drawn to it from the past current node.
            if o > 0:
                print("O IS  GREATER TO 0 ANIMATION")
            ...
            print(o, 'will this work?')

            def animate(t):
                print("HFLYHELIUHFLSIUHFILUS")
                x,y = inner(t)
                ax.plot(x, y, '#76EE00')
