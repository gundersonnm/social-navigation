...
def RoboSim():
    ...
    class RoboSim(object):
        ...
        while o < 40:
            ...
            while n < 9:
                ...
                while b < 22:
                    ObstacleCenterX = xminArray[b] + 0.5
                    ObstacleCenterY = yminArray[b] + 0.5
                    nodeDistance = 0
                ...
                if intersectCounter == 0:
                    ...
                    print("THERES AN OBSTACKE HERE OH MY GOD GUYS ITS RIGHT HERE AHEUHFLUSHBFLIUSHFLIUSHFILSFIUSHFLIU - - ! ! ! ! ")
                n = n + 1
    ...
    return pastCurrentNodeXArray, pastCurrentNodeYArray, ObstacleCenterX, ObstacleCenterY, o
